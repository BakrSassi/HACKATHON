...
function App() {
  ...
  // Si on affiche la page de connexion admin
  if (showAdminLogin && !isAuthenticated) {
    return <Login onLoginSuccess={handleAdminLoginSuccess} />;
  }

  // Si on affiche la page de connexion utilisateur
  if (showUserLogin && !isAuthenticated) {
      ...
      <header className="App-header">
        <div className="header-content">
          ...
          <nav className="main-nav">
            ...
            <button 
              className="nav-btn user-login-btn"
